...
def test_staticfiles_post(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_with_directory_returns_404(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_with_missing_file_returns_404(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_configured_with_missing_directory(tmpdir, client_factory):
    path = os.path.join(tmpdir, "no_such_directory")
...
def test_staticfiles_configured_with_file_instead_of_directory(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_304_with_etag_match(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_304_with_last_modified_compare_last_req(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
...
def test_staticfiles_with_invalid_dir_permissions_returns_401(tmp_path, client_factory):
...
def test_staticfiles_with_missing_dir_returns_404(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_access_file_as_dir_returns_404(tmpdir, client_factory):
    path = os.path.join(tmpdir, "example.txt")
    with open(path, "w") as file:
        file.write("<file content>")
...
def test_staticfiles_unhandled_os_error_returns_500(
    tmpdir, client_factory, monkeypatch
):
    ...
    monkeypatch.setattr("yaa.staticfiles.StaticFiles.lookup_path", mock_timeout)
